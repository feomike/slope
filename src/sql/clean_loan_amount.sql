...
delete from hmda.ffiec_lar_1991 where loan_amount like '% %';
...
delete from hmda.ffiec_lar_1993 where loan_amount like 'NA%';
delete from hmda.ffiec_lar_1993 where loan_amount like '%   %'
...
delete from hmda.ffiec_lar_1990 where loan_amount like '% %';
delete from hmda.ffiec_lar_1993 where loan_amount like '%   %'
delete from hmda.ffiec_lar_1994 where loan_amount like '%  %'
